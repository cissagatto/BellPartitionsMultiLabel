...
FolderJob = paste(FolderRoot, "/Jobs-Conda", sep="")
if(dir.exists(FolderJob)==FALSE){dir.create(FolderJob)}
  ...
  while(i<=n){
    ...
    nome_job = paste("BMP-", dataset$Name, sep="")
    ...
    str7 = paste("Rscript /home/u704616/BellPartitionsMultiLabel/R/bmp.R ",
                 dataset$Id, " \"/scratch/", nome_job, "\"", sep="")
